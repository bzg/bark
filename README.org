#+title: BONE - Backlog Of Notable Emails - 8==8
...
BONE monitors a single IMAP mailbox or Maildir, classifies incoming
...
See the manual ([[file:docs/bone-manual.org][docs/bone-manual.org]] § Multiple mailboxes) for the
